...
const PRECACHE = [
  ...
  './js/ajuda-chefes.js', './js/ajustes.js', './js/alpha.js', './js/arena.js', './js/boss.js', './js/evento.js', './js/hall.js', './js/amizade.js', './js/api.js', './js/batalha.js', './js/carreira.js', './js/config.js', './js/conta.js',
