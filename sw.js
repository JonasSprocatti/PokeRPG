...
const PRECACHE = [
  ...
  './js/criacao.js', './js/dados.js', './js/dados-familias.js', './js/dados-mapas.js', './js/dados-megas.js', './js/mega.js', './js/dados-patchnotes.js', './js/efeitos.js', './js/especiais.js', './js/estado.js', './js/evolucao.js', './js/fim.js', './js/golpe.js', './js/habilidades.js', './js/itens.js',
